 ...
 * [AppointmentFragment.OnListFragmentInteractionListener] interface.
 */
class AppointmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter =
                    MyAppointmentRecyclerViewAdapter(
                        myViewModel.getAppointments().toList(),
                        listener
                    )
            }
        }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: Appointment?)
    }
